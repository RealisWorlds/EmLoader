...
export class Coder {
    ...
    async _stageCode(code, actionLabel=null) {
        ...
        code = this.instrumentCode(code, actionLabel);
    ...
    instrumentCode(code, actionLabel=null) {
        const actionLabelText = `const actionLabel = "${actionLabel?actionLabel:'No Label'}";`;
        const clearDesign = `bot.blockList = [];\nbot.scaffoldBlocks = [];`;
    
        //separate these with \n
        let processedCode = `${actionLabelText}\n${clearDesign}\n${code}\n${clearDesign}`;
